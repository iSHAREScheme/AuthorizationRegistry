...
export class ProfileService {
  ...
  getRole(role: string) {
    switch (role) {
      ...
      case constants.roles.BcEntitledPartyCreator:
        return constants.rolesNames.BcEntitledPartyCreator;
      case constants.roles.BcEntitledPartyViewer:
        return constants.rolesNames.BcEntitledPartyViewer;
      case constants.roles.BcPartyAdmin:
        return constants.rolesNames.BcPartyAdmin;
      case constants.roles.CttPartyAdmin:
        return constants.rolesNames.CttPartyAdmin;
      case constants.roles.CttPartyUser:
        return constants.rolesNames.CttPartyUser;
