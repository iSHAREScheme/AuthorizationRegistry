 ...
 * certificate used to verify our own signatures.
 */
@Injectable()
...
async function loadPrivateKey(pem: string): Promise<KeyLike> {
  ...
  // jose@5 imports PKCS#8 directly, so callers should provide PKCS#8 PEMs
  // (the README documents the openssl conversion). This check gives a
