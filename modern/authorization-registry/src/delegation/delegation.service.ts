...
/**
 * Port of iSHARE.AuthorizationRegistry.Core.DelegationService +
 * iSHARE.AuthorizationRegistry.Data.DelegationsRepository, collapsed into
 * one Nest service since Prisma already abstracts the data layer.
 */
@Injectable()
export class DelegationService {
  ...
  /**
   * Port of CreateOrUpdatePolicyForParty. The stored policy is the canonical
   * iSHARE delegation evidence envelope (camelCase JSON).
   */
