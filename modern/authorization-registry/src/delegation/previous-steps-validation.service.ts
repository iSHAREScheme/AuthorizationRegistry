...
/**
 * Port of iSHARE.IdentityServer.Services.PreviousStepsValidationService.
 *
 ...
 * NOT be in the future — see Differences.md (the legacy implementation
 * accidentally returns 200 here when it should return 400).
 */
@Injectable()
