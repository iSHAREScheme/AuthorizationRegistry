 ...
 * Mirrors iSHARE.Api.ResponseJwtBuilder. The payload object is wrapped in
 * the iSHARE convention: a single named claim such as `delegationEvidence`
 * holding the original response body.
 */
@Injectable()
