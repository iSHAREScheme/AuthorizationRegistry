...
namespace iSHARE.IdentityServer.Validation.Token
{
    ...
    public class TokenRequestValidator : ICustomTokenRequestValidator
    {
        ...
        public Task ValidateAsync(CustomTokenRequestValidationContext context)
        {
            ...
            if (ShouldScopeBeValidated(context.Result.ValidatedRequest.GrantType) &&
                IsScopeValid(parameters.Get(OidcConstants.TokenRequest.Scope)))
            {
        ...
        private static bool ShouldScopeBeValidated(string grantType)
        {
        ...
        {
            return scope == null || !scope.Contains(StandardScopes.iSHARE, StringComparison.CurrentCultureIgnoreCase);
        }
    }
}
