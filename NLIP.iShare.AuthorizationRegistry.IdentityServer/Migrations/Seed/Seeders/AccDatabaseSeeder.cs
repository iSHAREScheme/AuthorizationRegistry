...
{
    internal class AccDatabaseSeeder : IdentityServerDatabaseSeeder, IDatabaseSeeder<ConfigurationDbContext>
    {
        public AccDatabaseSeeder(ILogger<AccDatabaseSeeder> logger,
            ISeedDataProvider<ConfigurationDbContext> seedDataProvider,
            ConfigurationDbContext context)
            : base(Environments.Acc, seedDataProvider, context, logger)
        {
        }
